...
namespace DrawTool.DrawObjects
{
    ...
    public abstract class DrawObject
    {
        ...
        public virtual void SetConnect(DrawObject obj, int handleNumber)
        {

        }

        public virtual void SetArgument(string instruction, List<string> argument, List<Image> iconImages)
        {
        ...
        protected void FillDrawObjectFields(DrawObject drawObject)
        {
            ...
            drawObject.deleted = this.deleted;
